...
public interface ProfessionalMapper {
    ...
    @Mapping(source = "themeTextPrimaryColor", target = "themeTextPrimaryColor")
    ...
    @Mapping(source = "themeHoverColor", target = "themeHoverColor")
    @Mapping(source = "themeDisabledColor", target = "themeDisabledColor")
