...
ALTER TABLE modules ADD COLUMN IF NOT EXISTS order_index INTEGER NOT NULL DEFAULT 0;
...
CREATE INDEX IF NOT EXISTS idx_modules_created_by_order ON modules(created_by, order_index);