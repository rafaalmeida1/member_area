            ...
            try {
                ...
                if (inviteData.createdBy?.id) {
                    localStorage.setItem(
                        "invited_by_professional_id",
                        inviteData.createdBy.id.toString()
                    );
                }
            } catch (error) {
                ...
                <div className="invite-register-form-card">
                    ...
                    <div className="invite-info">
                        ...
                        <p className="invite-description">
                            ...
                            <strong>{invite.createdBy?.name}</strong> para
                            participar do Nutri Thata. Complete seu cadastro
                            para começar.
                        </p>
                    </div>
                    ...
                    <form
                        ...
                        className="invite-register-form"
                    >
