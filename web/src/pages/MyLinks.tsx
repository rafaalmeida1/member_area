...
const renderIconByValue = (iconValue: string | undefined, size = 20, customColor?: string) => {
...
const renderSocialIcon = (linkType: LinkType, size = 20, customColor?: string) => {
  const color = customColor || "currentColor";
                        ...
                        <SelectItem key={icon.value} value={icon.value}>
                          <div className="flex items-center gap-2">
                            <div className="w-4 h-4 flex items-center justify-center">
                              {renderIconByValue(icon.value, 16, "currentColor")}
                            </div>
                            {icon.label}
                          </div>
                        </SelectItem>
                            ...
                            <div className="w-full">
                                ...
                                {links.filter(link => link.displayAsIcon && link.isActive).slice(0, 4).map((link) => (
                                  ...
                                  >
                                    ...
                                    <div className="w-8 h-8 rounded-full flex items-center justify-center shadow-sm" 
                                      ...
                                      {renderIconByValue(link.icon, 14, "white") || 
                                        renderSocialIcon(link.linkType, 14, "white")
                                      }
                                    </div>
                                  </div>
                                ))}
                              ...
                              <div className="space-y-3">
                                {links.filter(link => !link.displayAsIcon && link.isActive).slice(0, 3).map((link) => (
                                  ...
                                  >
                                    {renderIconByValue(link.icon, 12, "white") && (
